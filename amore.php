...
<body class="container" style="background-color:Red;">
 ...
 <br>
 <div class="row">
 <a class="btn btn-success btn-lg " data-toggle="modal" data-target="#formforaddproduct"> Add New Product </a>
 <a class="btn btn-success btn-lg " data-toggle="modal" data-target="#formfordeleteproduct"> Delete Product </a>
 </div>
<?php ?>
<!--AddNEWPRODUCT-->
<?php
...
<br><br><br><br><br>
    <!-- Modal content-->
	  ...
	  <!-- FORM START -->
                   ...
                   <div class="form-group">
                    <label for="ProN" >Enter Product Name(Product Name Should be One Word):-</label>
